            ...
            <div className="flex flex-col space-y-4">
                <article>
                    <div className="flex flex-row items-center gap-2">
                        ...
                        <span className="self-end text-xs md:text-lg">(<a className="underline font-medium" href="https://code-track.vercel.app/" target="_blank" rel="noopener noreferrer">code-track.vercel.app</a>)</span>
                    </div>
                ...
                <article>
                    <div className="flex flex-row items-center gap-2">
                        <h3 className="text-md md:text-lg md:text-xl font-medium font-heading">Heart Disease Predictor</h3>
